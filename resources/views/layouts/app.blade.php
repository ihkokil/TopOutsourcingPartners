...
<head>
    ...
    <meta name="description"
        content="@yield('meta_description', 'Top Outsourcing Partners provides cost-effective, scalable outsourcing solutions for businesses worldwide. From accounting & finance to AI integration, corporate training, and third-party business support - we help you streamline operations and drive growth.')">
    <meta name="keywords"
        content="@yield('meta_keywords', 'outsourcing, business solutions, accounting outsourcing, AI integration, corporate training, third-party support, cost-effective, scalable, business growth')">
    ...
    <script src="https://cdn.tiny.cloud/1/si1oqrkmp8u8g75rhq9vf6hz3vdegcww6rkzb9iakkz3t5ss/tinymce/6/tinymce.min.js"
...
<body>
    ...
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MNHR9CMF" height="0" width="0"
    ...
    animatedElements.forEach(el => {
        ...
        if (el.classList.contains('animate__animated')) {
            const animationClass = Array.from(el.classList).find(cls => cls.startsWith('animate__') && cls !==
                'animate__animated');
            if (animationClass) {
